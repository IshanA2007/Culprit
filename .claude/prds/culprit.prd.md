...
| 3 | Full diagnosis layer | 8–12 runbooks authored for tCF's actual failure modes and offered correctly; deterministic impact numbers in briefs; SNS/CloudWatch ingest catches app-too-dead-for-Sentry failures | in-progress | `.claude/plans/culprit-m3-diagnosis-layer.plan.md` |
